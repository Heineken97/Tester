    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deviceRegisterBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try { valueSerialDevice = Integer.parseInt(serialDevice); } catch (NumberFormatException nfe) { nfe.printStackTrace(); }
...
//        deviceTypeText.setAdapter(dataAdapter);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        if(parent.getId() == R.id.spinnerRoom)
        {
            roomDevice= parent.getItemAtPosition(position).toString();
        }
        else if(parent.getId() == R.id.deviceType)
        {
